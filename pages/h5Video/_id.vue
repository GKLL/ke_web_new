 ...
 * @Date: 2018-06-19
 * @Last Modified by: cb
 * @Last Modified time: 2018-06-21 14:35:29
 */
<template>
  <section class = "h5video-container">
    ...
    <section class = 'video-content' >
      <!-- 视频地址不为iframe链接 -->
        ...
        <!-- 视频地址为iframe链接 -->
        <iframe v-else-if="(videoData.videoFilename == null || videoData.videoFilename == '') && videoData.videoUrl.indexOf('iframe') == -1" style = "width:100%;height:211px" frameborder="0" allowfullscreen="true" :src="videoData.videoUrl"></iframe>
    ...
    <main class="video-main">
      ...
      <section class = "h5video-detail">
        ...
        <section class="video-bottom">
            ...
            <section class="toApp" @click="goApp">打开APP，获取阅读奖励</section>
        </section>
      </section>
      <!-- 空白条 -->
