 ...
 * @Last Modified by: cb
 * @Last Modified time: 2018-06-22 14:53:13
 */
<template>
  <section class="login">
    <el-row>
              ...
              <el-tab-pane label="账号登录" name="账号登录">
                ...
                <el-form ref="form1" :model="form1" :rules="rules1">
                  ...
                  <el-form-item label="" class="input-password" prop="userPassword">
                    <el-input type="password" v-model="form1.userPassword" placeholder="密码"></el-input>
                    <nuxt-link to="/forgotpwd" class="forget-password-link">忘记密码?</nuxt-link>
                  </el-form-item>
                  <p class="not-account-info">还没有账户?  <nuxt-link to="/register" class="register-link">立即注册</nuxt-link></p>
                ...
                <el-form ref="form2" :model="form2" :rules="rules2">
                  <el-form-item label="" prop="phone">
                    <el-row>
                      ...
                      <el-col :span="18"><el-input v-model="form2.phone" placeholder="手机号"></el-input></el-col>
                    </el-row>
                  </el-form-item>
              ...
              axios.post('/userkg/checkLogin', data).then(({ data }) => {
                if (data.code === '10000') {
                  ...
                  this.$store.dispatch('userLogin', result).then(() => {
                    handleWebStorage.setLocalData('userAvatar', result.avatar)
                    location.href = handleWebStorage.getLocalData('prevUrl', 'sessionStorage')
                    // this.$router.push({path: '/' + handleWebStorage.getLocalData('prevUrl', 'sessionStorage'), query: {t: 'reload'}})
                  })
                }else {
                  this.$message({
