...
<div class="generalPersonInfo">
    ...
    <div class="generalPersonDetail">
        ...
        <p> {{generalPersonData.columnintro}}</p>
        <img :src="generalPersonData.avatar" :alt="generalPersonData.columnName">
    ...
    <div class="generalPersonComments">
        ...
        <div class="mycomment" v-for="(item, index) in myCommentList.data" :key="index">
            ...
            <!-- <i @click="toArticle(item.articleId)">《{{item.articleTitle}}》</i> -->
                <nuxt-link :to="concatUrl('article', item.articleId)" target="_blank">《{{(item.articleTitle)}}》</nuxt-link>
            </p>
...
export default {
  head: {
    title: "千氪财经签约普通用户个人信息",
    meta: [
      {
        hid: "keywords",
        name: "keywords",
        content: "千氪财经签约普通用户个人信息"
      },
      {
        hid: "description",
        name: "description",
