  ...
  <section class = 'account-safe'>
    ...
    <section class = 'account-lists'>
      <div>
        ...
        <svg-icon v-popover:popover1 iconClass="info" class="svg-icon info"></svg-icon>
        <el-popover
          ref="popover1"
          placement="top"
          width="200"
    ...
    <section class = 'account-lists'>
      <div>
        ...
        <svg-icon v-popover:popover2 iconClass="info" class="svg-icon info"></svg-icon>
        <el-popover
          ref="popover2"
          placement="top"
          width="200"
    ...
    <section class = 'account-lists'>
      <div>
        ...
        <svg-icon v-popover:popover3 iconClass="info" class="svg-icon info"></svg-icon>
        <el-popover
          ref="popover3"
          placement="top"
          width="200"
    ...
    <section class = 'account-lists'>
      ...
      <div>
        ...
        <span class = 'account-handle' @click = "pwdVisible = true">{{accountData.accountFrom == 1 ? '修改' : '设置'}}</span>
      </div>
    </section>
    <!-- 实名认证 -->
    <section class = 'account-lists'>
      <div>
        ...
        <svg-icon v-popover:popover4 iconClass="info" class="svg-icon info"></svg-icon>
    ...
    <section class = 'account-lists'>
      ...
      <div>
        ...
        <svg-icon v-popover:popover5 iconClass="info" class="svg-icon info"></svg-icon>
        <el-popover
          ref="popover5"
          placement="top"
          width="200"
...
export default {
  ...
  components: {
    SvgIcon,ModifyPhone,ModifyPwd,TraderPwd,RealName
  },
  computed: {
    ...mapState([
      'KGUser'
