...
<template>
      <div>
        ...
        <!-- 下一步操作 -->
        <modify-new-phone :visible = "newPhoneVisible" :slideInfo="slideInfo" :handleSlide="handleSlide" :getAccountInfo="getAccountInfo" :accountDataHandle="accountDataHandle"/>
      </div>
</template>
