        ...
        <el-dialog
              ...
              <el-form  :model="ruleForm" :rules="rules" ref="ruleForm">
                    <el-form-item label="" prop="userPassword">
                      <el-input type="password"  v-model="ruleForm.userPassword" size = 'small' class="martop20" placeholder="请输入原密码" ></el-input>
                    </el-form-item>
                    <el-form-item label="" prop="newPwd">
                      <el-input type="password" v-model="ruleForm.newPwd"  size = 'small' class="martop20" placeholder="请输入新密码" ></el-input>
                    </el-form-item>
                    <el-form-item label="" prop="confirmPwd">
                      <el-input type="password"  v-model="ruleForm.confirmPwd" size = 'small' class="martop20" placeholder="请再次输入新密码"></el-input>
                    </el-form-item>
