              ...
              <el-form  :model="ruleForm" :rules="rules" ref="ruleForm" label-width="110px">
                    ...
                    <el-form-item label="身份证扫描件:" style = "height:178px">
                      <div class='upload-card'>
                        <div>
                          <span class = 'pic' :style="imageUrl.idcard1 ?  {background: 'url(' + imageUrl.idcard1 + ') no-repeat center/cover'} : {background: '#ebebeb'}">{{imageUrl.idcard1 ? '' : '正面'}}</span>
                          <el-upload
                            class="upload-btn"
                            :action="uploadUrl"
                        ...
                        <div>
                          <span class = 'pic' :style="imageUrl.idcard2 ?  {background: 'url(' + imageUrl.idcard2 + ') no-repeat center/cover'} : {background: '#ebebeb'}">{{imageUrl.idcard2 ? '' : '反面'}}</span>
                          <el-upload
                            class="upload-btn"
                            :action="uploadUrl"
                            :show-file-list="false"
                        ...
                        <div>
                          <span class = 'pic' :style="imageUrl.idcard3 ?  {background: 'url(' + imageUrl.idcard3 + ') no-repeat center/cover'} : {background: '#ebebeb'}">{{imageUrl.idcard3 ? '' : '手持身份证正面照'}}</span>
                          <el-upload
                            class="upload-btn"
                            :action="uploadUrl"
                            :show-file-list="false"
...
export default {
  data () {
    ...
    return {
        uploadUrl:"https://dev.kg.com/image/upload",
